...
<div className='flex-grow '>
    <header className="top-5 right-8 absolute">
        <div className={`flex items-center text-white outline outline-1 ${color} space-x-3 transition hover:opacity-80 cursor-pointer rounded-full p-1 pr-2`}>
    ...
    <section className={`flex items-end space-x-7 w-full bg-gradient-to-b to-black ${color} text-white p-8`} >
        <h1 className="text-4xl font-extrabold">Top Tamil Trending</h1>
    </section>
</div>
)}